...
# ===== Model config =====
MODEL_PATH = 'violence_model.keras'   # phải đúng tên file model đã save
IMAGE_HEIGHT, IMAGE_WIDTH = 64, 64
SEQUENCE_LENGTH = 10                  # đúng với model bạn train
CLASS_LIST = ["Violence", "Nonviolence"]  # đổi lại nếu label train của bạn ngược
